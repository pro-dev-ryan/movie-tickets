...
const DetailsPage = ({ item, id }) => {
  ...
  return (
    <Col className="container-lg container-fluid">
      <Link
        style={{
          textDecoration: "none",
        }}
        className="bg-info text-light border rounded px-3 py-1 "
        to="/"
      >
        Back to Home
      </Link>
      <Row className="mx-md-0 mx-lg-auto m-0 my-md-5 my-2 py-lg-2">
